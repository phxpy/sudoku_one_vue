<template>
    <div class="controls">
        ...
        <ul class="controls__aside">
            ...
            <li class="controls__item">
                <button class="controls__item-label controls__item-label--danger" id="refreshBtn">refresh sudoku
        ...
        <button class="controls__item-btn numpad__btn numpad__btn--wide" id="deleteBtn">delete</button>
